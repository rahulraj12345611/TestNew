...
export const FooterLogo = () => {
  return (
    <FooterLogoStyle>
      <h2>
        <strong style={{color: "white"}}>The </strong>Brain Connections
      </h2>
      {/* <Image /> */}
    </FooterLogoStyle>
  );
...
export const Linkedin = () => {
  return (
    <Socials href="https://www.linkedin.com/in/vineeta-gupta-25b91916a">
      <svg
        width="16"
        height="17"
        viewBox="0 0 16 17"
...
export const Instagram = () => {
  return (
    <Socials href="https://www.instagram.com/vineetaagupta08/">
      <svg
        width="16"
        height="17"
        viewBox="0 0 16 17"
...
export const Twitter = () => {
  return (
    <Socials href="https://youtube.com/channel/UC6vH39539oaLiC4ojpVO4KA">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.251577" stopColor="#228B22" />
