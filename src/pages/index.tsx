...
const Faq = dynamic(() => import("../components/HomepageComp/Faq"), {ssr: false});
const PopularCourses = dynamic(() => import("../components/HomepageComp/PopularCourses"), {ssr: false});
// issues
...
export default function Home() {
  return (
    <>
      <Head>
        <title>The Brain Connections</title>
